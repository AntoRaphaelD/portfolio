  ...
  return (
    ...
    <div className="min-h-screen bg-black relative overflow-hidden">
      ...
      <div className="absolute top-8 left-12 z-10">
        <h1 className="fixed top-8 left-4 z-10 text-white text-[1.5em] font-pacifico inline-block">
  AR &larr;
</h1>
      ...
      <div className="absolute top-20 left-12 opacity-10">
        <h1 className="text-[200px] font-bold text-gray-400 leading-none">ABOUT</h1>
      </div>
      ...
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-full max-w-4xl px-8">
        <div className="flex items-center gap-12">
          ...
          <div className="flex-1 border-2 border-white p-8">
            <p className="text-white text-lg font-mono leading-relaxed mb-6">
