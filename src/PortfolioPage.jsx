...
const PortfolioPage = () => {
  ...
  useEffect(() => {
    // Add rotation animation to the Yin-Yang image
  ...
  return (
    <div className="bg-white min-h-screen w-full text-black">
      ...
      {/* Main Container */}
      <div className="relative w-full h-screen rounded-xl overflow-hidden bg-gray-50">
        {/* Header Bar */}
        ...
        {/* Center Navigation */}
        <div className="absolute top-10 left-1/2 transform -translate-x-1/2 flex items-center space-x-6">
  {/* Resume PDF Link */}
  <a 
    href={resume} 
    target="_blank" 
  ...
  <button 
    onClick={() => navigate(-1)}
    className="rounded-full border border-gray-400 p-3 hover:bg-gray-100 transition-colors"
  >
    <svg
      ...
      />
        ...
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 flex flex-col items-center justify-center">
          <div className="cursor-pointer" onClick={handleClick}>
            ...
            <p className="absolute left-[56px] mt-5 text-lg text-gray-900 font-semibold text-center">
              click here
            </p>
          </div>
        </div>
        ...
        <div className="absolute bottom-0 left-0 right-0 flex justify-center pb-10">
          <div className="flex gap-40">
            <Link to="/about" className="text-2xl font-medium hover:text-gray-600">
              About
            </Link>
            <Link to="/skills" className="text-2xl font-medium hover:text-gray-600">
              My Skills
            </Link>
          </div>
        </div>
        ...
        {/* Projects Label */}
        <div className="absolute left-[55px] top-[200px] flex flex-col">
          <Link to="/projects" className="-rotate-90 transform origin-top-left whitespace-nowrap text-2xl font-medium tracking-wider hover:text-gray-600">
            Projects
          </Link>
        </div>        
      </div>
